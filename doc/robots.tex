...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        \subsubsection{ graphical/Scrollable.java }
            É a classe que representa o JPanel com movimentação da imagem.
            Ele recebe os eventos do teclado das setas cima,
             baixo, direita e esquerda.
            Movimentando a tela de acordo com a seta utilizada, funciona 
            de modo análogo a barra de rolagem.
