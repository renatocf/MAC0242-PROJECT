...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\subsection{Scenario}
		...
		\subsubsection{ Scenario.java }
		    ...
		    {\textcolor{blue}{ public int getHP() }
		    Retorna o número de vidas do presentes no robô.
		    
            {\textcolor{blue}{ public int takeDamage (int damage) }
...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\subsection{Stackable}
		...
		\subsubsection { Addr.java }
			...
			{\textcolor{blue}{ public Addr(int address) }
			que é o construtor de objetos do tipo Addr.
			
			{\textcolor{blue}{ public int getAddress() }
			que retorna o valor do endereço como um 
			inteiro.
		
			{\textcolor{blue}{ public String toString() }
		...
		\subsubsection { Around.java }
			...
			{\textcolor{blue}{ public Around(Terrain[] seeing) }
   
    
    		{\textcolor{blue}{ public String[] indexToPosition
    		(int index) }
		    ...
		    {\textcolor{blue}{ public void print() }
		...
		\subsubsection { Attack.java }
			...
			{\textcolor{blue}{ public Attack(String s) }
   			um construtor que monta o objeto a partir da
   			String passada.
			
			{\textcolor{blue}{ public String getAttack() }
		...
		\subsubsection { Direction.java }
			...
			direções 
			{\textcolor{blue}{E}  (leste), 
			{\textcolor{blue}{NE} (nordeste), 
			{\textcolor{blue}{NW} (noroeste),
			{\textcolor{blue}{W}  (oeste), 
			{\textcolor{blue}{SW} (sudoeste) e 
			{\textcolor{blue}{SE} (sudeste).
			...
			{\textcolor{blue}{ public Direction(int move, int dir) } 
			...
			{\textcolor{blue}{ public int[] get(int row) }
			...
			{\textcolor{blue}{  private void set(int even\_x, int even\_y, 
			int odd\_x, int odd\_y) }
		...
		\subsubsection { Text.java }
			...
			{\textcolor{blue}{public String getText() }
