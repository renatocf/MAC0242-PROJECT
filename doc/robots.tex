...
\section{Introdução} \label{sec:introdução}
    ...
    Nesta fase final, temos um jogo "jogável", onde além da interface
    gráfica, há a presença da linguagem própria para o jogo feita em 
    javacc. Portanto, agora o usuário pode programar seus próprios 
    robôs numa linguagem mais simples e confortável para ele, podendo 
    assim montar robôs mais eficientes.
    
    As especificações da linguagem estão no manual de usuário.
    
    Também há a opção de criar robôs em tempo real (no meio de um jogo)
    programando na hora, em um editor de texto fornecido pelo programa
    e do mesmo modo também há a opção de modificar o programa dos robôs 
    apenas clicando neles.    
    ...
    \begin{itemize}
        ...
        \item \textbf{build:}     Possui os arquivos .class
        
        \item \textbf{data:}      Onde estão os programas teste em assembly
        						  do robô;
        						  
        \item \textbf{dist:}      Armazena todo o programa compactado.
        						  
        \item \textbf{doc:}       Armazena as imagens do jogo e os programas
                                  .pos na linguagem do jogo.
                                  
        \item \textbf{lib:}       Arquivos com classes/pacotes de Perl 
                                  no formato \texttt{.pm};
                                  
        \item \textbf{scripts:}   Armazena os bash scripts do programa.
        ...
        \item \textbf{user:}      Armazena os programas criados pelo usuário
                                  durante o jogo.
