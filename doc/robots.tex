...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
	...
	\subsection{Exception}
		...
		elementos conforme símbolos pré-definidos dentro do módulo, 
		simulando visualmente o jogo no terminal.
		Todas as cores são feitas com o uso de \emph{Ansi Escape Codes}, 
		e o módulo só deve ser usado em terminais que suportem a impressão 
		destas sequências de escape.
